...
public partial class Visiter : System.Web.UI.Page
{
    ...
    protected void btnBefore_Click(object sender, EventArgs e)//上一页
    {
        ...
        string sql1 = "select* from inf where id0 = '" + userID + "'and id3 = '" + 0 + "'and id2='" + 1 + "'order by datetime desc";
    ...
    protected void dairy_Click(object sender, EventArgs e)
    {
        ...
        Label1.Text = name;
        string visiter = Session["name"].ToString();
        string sql1 = "select * from inf where id0='" + userID + "'and id3='" + 0 + "'and id2='" + 0 + "'";
    ...
    protected void photo_Click(object sender, EventArgs e)
    {
        ...
        string sql1 = "select*from Photo where ID='" + userID + "'";
        DataTable dt = new DataTable();
        dt = Class.Table(sql1);
    ...
    protected void massage_Click(object sender, EventArgs e)
    {
        ...
        string visiter = Session["name"].ToString();
        //string ID = Session["ID"].ToString();
        string sql1 = "select*from massage where ID1='" + userID + "'order by datetime desc";
        DataTable dt = new DataTable();
        dt = Class.Table(sql1);
    ...
    protected void btnBefore_Click1(object sender, EventArgs e)//上一页
    {
        ...
        string sql = "select * from inf where id='" + id + "'";
        string name = Class.Search5(sql);
        string userID = Class.Search(sql);
        Label1.Text = name;
        string visiter = Session["name"].ToString();
        string sql1 = "select * from inf where userID='" + userID + "'and id3='" + 0 + "'and id2='" + 0 + "'order by datetime desc";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string name = Class.Search5(sql);
        string userID = Class.Search(sql);
        string sql3 = "select * from tabUsers where ID='" + userID + "'";
        string picture = Class.Search6(sql3);
        Label1.Text = name;
        string visiter = Session["name"].ToString();
        string ID = Session["ID1"].ToString();
        string massage = massage2.Text;
        string sql2 = "insert into massage(ID1,ID2,name,massagematter,picture) values('" + userID + "','" + ID + "','" + visiter + "','" + massage + "','" + picture + "')";
    ...
    protected void btnBefore_Click2(object sender, EventArgs e)
    {
        ...
        Label1.Text = name;
        string visiter = Session["name"].ToString();
        string sql1 = "select * from Photo where userID='" + userID + "'order by datetime desc";
